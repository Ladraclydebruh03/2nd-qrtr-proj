...
public class Bishop extends Piece{
    ...
    public Bishop(String n, int posX, int posY, int v, String c){
    ...
    public void Move (Board board, int newX, int newY){
        ...
        if(Math.abs(tileNum-newTileNum)%7==0 || Math.abs(tileNum-newTileNum)%9==0){
    ...
    public void Capture(Board board, int newX, int newY){
        ...
        if((Math.abs(tileNum-newTileNum)%7==0 || Math.abs(tileNum-newTileNum)%9==0)&& board.getPieceOnTile(newX, newY)!=null){

...
public class Rook extends Piece{
    ...
    public Rook(String n, int posX, int posY, int v, String c){
    ...
    public void Move (Board board, int newX, int newY){
        ...
        if(Math.abs(tileNum-newTileNum)%8==0 || currentY==newY){
    ...
    public void Capture(Board board, int newX, int newY){
        ...
        if((Math.abs(tileNum-newTileNum)%8==0 || currentY==newY) && board.getPieceOnTile(newX, newY)!=null){
